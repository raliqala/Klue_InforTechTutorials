...
namespace NewKLUE.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult AccountEmailConfirmation()
        {
           return  View();
        }
        //
        ...
        public async Task<ActionResult> Register([Bind(Exclude = "UserPhoto")]RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (Request.Files.Count > 0)
                {
                    ...
                    var user = new ApplicationUser { UserName = model.Email, Email = model.Email, FirstName = model.FirstName, LastName = model.Lastname, Gender = model.Gender, Country = model.Country, Region = model.Region, UserBio = model.UserBio, WebUrl = model.WebUrl, CompanyName = model.CompanyName };
